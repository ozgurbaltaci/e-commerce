...
const MainPage = () => {
  ...
  useEffect(() => {
    let apiUrl = "https://e-commerce-back-end-two.vercel.app/getProducts";
  ...
  useEffect(() => {
    ...
    const apiUrl = "https://e-commerce-back-end-two.vercel.app/getCategories"; // Replace with your API URL
  ...
  useEffect(() => {
    axios
      .get(`https://e-commerce-back-end-two.vercel.app/getAllSubCategories`)
      .then((response) => {
